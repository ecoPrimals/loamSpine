...
//! Capability registry unit tests: registration, unregistration, status
//! queries, clone semantics, service-registry error paths, and the dynamic
//! signer/verifier trait object interfaces.
