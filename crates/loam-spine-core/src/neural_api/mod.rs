...
fn capability_list_inner() -> serde_json::Value {
    serde_json::json!({
        ...
        "provided_capabilities": [
            { "type": "spine", "methods": ["create", "get", "seal"], "version": env!("CARGO_PKG_VERSION"), "stability": "stable", "description": "Append-only spine lifecycle" },
            { "type": "entry", "methods": ["append", "get", "get_tip"], "version": env!("CARGO_PKG_VERSION"), "stability": "stable", "description": "Content-addressed entry management" },
            ...
            { "type": "anchor", "methods": ["publish", "verify"], "version": env!("CARGO_PKG_VERSION"), "stability": "stable", "description": "Public chain anchoring" },
            { "type": "session", "methods": ["commit"], "version": env!("CARGO_PKG_VERSION"), "stability": "stable", "description": "Provenance trio session commit" },
