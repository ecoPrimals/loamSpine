...
fn capability_list_inner() -> serde_json::Value {
    serde_json::json!({
        ...
        "provided_capabilities": [
            ...
            { "type": "certificate", "methods": ["mint", "transfer", "loan", "return", "get"], "version": env!("CARGO_PKG_VERSION"), "description": "Certificate lifecycle and provenance" },
            ...
            { "type": "slice", "methods": ["anchor", "checkout"], "version": env!("CARGO_PKG_VERSION"), "description": "Waypoint slice operations" },
            { "type": "btsp", "methods": ["negotiate"], "version": env!("CARGO_PKG_VERSION"), "description": "BTSP Phase 3 cipher negotiation" },
            { "type": "lifecycle", "methods": ["status"], "version": env!("CARGO_PKG_VERSION"), "description": "Service lifecycle status" },
