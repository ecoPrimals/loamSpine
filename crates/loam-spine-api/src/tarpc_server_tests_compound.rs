...
//! Compound tarpc server tests — multi-step operations.
//!
//! Extracted from `tarpc_server_tests.rs`. These tests exercise operations
//! that require create→mutate→verify sequences: transfers, loans, waypoints,
//! proofs, and error paths for non-existent resources.
