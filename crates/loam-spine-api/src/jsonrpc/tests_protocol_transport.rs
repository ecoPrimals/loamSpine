...
// =========================================================================
// PG-52: UDS trio lifecycle — spine.create / entry.append / spine.seal
//
// Verifies the full create → append → seal cycle over UDS JSON-RPC.
// Prior to PG-52 these methods were only tested via direct handler calls,
// not through the transport layer.
// =========================================================================
