...
[![Tests](https://img.shields.io/badge/tests-1%2C711%20passing-brightgreen)]()
...
| **Version** | 0.9.16 |
| **Edition** | 2024 |
| **Tests** | 1,711 passing (all concurrent, ~3s, zero flaky) |
...
| **Source Files** | 206 `.rs` files across 3 workspace crates (+ 3 fuzz targets) |
