...
[![Tests](https://img.shields.io/badge/tests-1%2C383%20passing-brightgreen)]()
...
| **Version** | 0.9.16 |
| **Edition** | 2024 |
| **Tests** | 1,390 passing (all concurrent, ~3s, zero flaky) |
...
| **Source Files** | 176 `.rs` files across 2 crates + binary (+ 3 fuzz targets) |
