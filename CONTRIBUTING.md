...
- **High Coverage**: Aim for 90%+ line coverage (current: 90.92% line / 92.92% region, 1,442 tests)
...
# Test (1,442 tests, all concurrent)
...
| SPDX Headers | All 178 source files |
| Source files | 178 `.rs` across workspace (+ 3 fuzz targets) |
