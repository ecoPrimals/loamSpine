...
- **High Coverage**: Aim for 90%+ line coverage (current: 92.26% line, 1,684 tests)
...
# Test (1,684 tests, all concurrent)
...
| Version | 0.9.16 |
| Edition | 2024 |
| Tests | 1,684 (all concurrent, ~3s, zero flaky) |
...
| Source files | 202 `.rs` across workspace (+ 3 fuzz targets) |
