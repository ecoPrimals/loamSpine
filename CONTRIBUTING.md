...
- **High Coverage**: Aim for 90%+ line coverage (current: 92.26% line, 1,704 tests)
...
# Test (1,704 tests, all concurrent)
...
| Version | 0.9.16 |
| Edition | 2024 |
| Tests | 1,704 (all concurrent, ~3s, zero flaky) |
...
| SPDX Headers | All 206 source files |
