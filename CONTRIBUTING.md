...
- **High Coverage**: Aim for 90%+ line coverage (current: 90.92% line / 92.92% region, 1,504 tests)
...
# Test (1,504 tests with --all-features, all concurrent)
...
| SPDX Headers | All 184 source files |
| Source files | 184 `.rs` across workspace (+ 3 fuzz targets) |
